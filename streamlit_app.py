...
with st.sidebar:
  ...
  driver_id = drivers.loc[drivers['driverRef'] == driver_name, 'driverId'].iloc[0]
  constructor_id = constructors.loc[constructors['name'] == constructor_name, 'constructorId'].iloc[0]
